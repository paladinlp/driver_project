...
flags.DEFINE_integer("train_size", 100, "The size of train images [np.inf]")
...
def main(_):
    ...
    with tf.Session(config=tf.ConfigProto(
        ...
        dcgan = DCGAN(sess, image_size=FLAGS.image_size, batch_size=FLAGS.batch_size,
                    ...
                    generator=Generator(),
                    train_func=train, discriminator_func=discriminator, predictor_func = predictor,#自己加的一个预测的函数集
